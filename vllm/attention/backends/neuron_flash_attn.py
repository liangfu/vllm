...
class NeuronFlashAttentionBackend(AttentionBackend):
    ...
    def get_impl_cls() -> Type["NeuronFlashAttentionBackendImpl"]:
        return NeuronFlashAttentionBackendImpl
...
class NeuronFlashAttentionBackendImpl(AttentionImpl):
    ...
    def forward(
        ...
        attn_metadata: NeuronFlashAttentionMetadata,  # type: ignore
        kv_scale: float,
    ) -> torch.Tensor:
        """Forward pass with Neuron PA and PagedAttention.
        ...
        if attn_metadata.is_prompt:
            ...
            if (kv_cache is None or attn_metadata.block_tables.numel() == 0):
                ...
                raise RuntimeError(
                    "Neuron backend doesn't support prefix decoding.")

...
# HACK AOYU add excution model from old tpu_model_runner
import enum
...
class TPUModelRunner:
    ...
    def __init__(
        ...
        # HACK AOYU pin memory is not supported in Neuron
        ...
        #     parallel_config)
        # HACK AOYU make num_attn_layers = 1 since only for profile and initilize kv cache

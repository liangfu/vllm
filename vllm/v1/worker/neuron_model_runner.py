...
class NeuronModelRunner:
    ...
    def _prepare_inputs(
        ...
        # key_cache, _ = self.kv_caches[0]
        # num_blocks, block_size, _, _ = key_cache.shape
        # seq_lens = [num_blocks*block_size for _ in range(len(query_lens))]
        ...
        # active_block_table = active_block_table.to(torch.int32).to(device=self.device)
